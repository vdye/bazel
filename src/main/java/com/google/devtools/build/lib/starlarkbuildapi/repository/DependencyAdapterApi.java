...
/**
 * The Starlark module containing the definition of {@code dependency_adapter} function to define a
 * Starlark dependency adapter.
 */
@DocumentMethods
public interface DependencyAdapterApi {

  @StarlarkMethod(
      name = "dependency_adapter",
      doc =
          "Creates a new dependency adapter. Store it in a global value, so that it can be loaded and "
  ...
  StarlarkCallable dependencyAdapter(
